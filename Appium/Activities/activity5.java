...
public class activity5 {
    ...
    public void smsTest() {
        ...
        // Press Send
        driver.findElement(AppiumBy.xpath("//android.widget.LinearLayout[@content-desc='Send SMS']")).click();

        // Assertion
        String messageTextSent = wait.until(ExpectedConditions.presenceOfElementLocated((AppiumBy.id("message_text")))).getText();
